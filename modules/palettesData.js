/**
 * 🎨 palettesData.js
 * Définit les objets hexadécimaux : noms de couleurs
 * Utilisé par config.js pour alimenter nomsCouleursParPalette
 */

export const royalDuskPalette = {
    "#1C1C1C": "Noir profond",
  ...
  export const carnavalElectriquePalette = {
    "#FF3F3F": "Rouge cerise",
    "#FF6F61": "Corail vif",
  ...
  export const solsticeClairPalette = {
  ...
  export const terraFortePalette = {
    "#A68A64": "Argile grise",
    "#DDB892": "Sable rosé",
    "#BC6C25": "Cuivre sec",
    "#99582A": "Noisette",
  ...
  export const eclatsFruitesPalette = {
  ...
  export const sunsetBloomPalette = {
    "#FFF3E0": "Pêche pastel",
    "#FFE0B2": "Abricot doux",
  ...
  export const melodieNocturnePalette = {
    "#1B263B": "Bleu minuit",
  ...
  export const vintageBooksPalette = {
    "#FFF8E1": "Ivoire doux",
